      ...
      <div class="page3">
        ...
        <div class="chart-box">
            <div class="history item">
                ...
                <div class="chart" id="big_charts_box">
...
export default {
  ...
  mounted () {
      const chart_box = this.$echarts.init(document.getElementById('big_charts_box'));
  ...
  methods: {
      ...
      getStartdata(){
        ...
        this.$http.get("/api/data/startTimeLength", data).then((d) => {
            ...
            const bar_box = this.$echarts.init(document.getElementById('big_charts_box'));
      ...
      getRundata(){
        ...
        this.$http.get("/api/data/electricData", data).then((d) => {
            ...
            const line_box = this.$echarts.init(document.getElementById('big_charts_box'));
