      ...
      <div class="legend" v-show="isCurrent == 'status'">
        <ul>
          <li>
            ...
            <span>一共{{ ajaxData.totalNum ? ajaxData.totalNum : 0 }}台机器</span>
          </li>
          <li>
          ...
          <li>
            ...
            <span style="color:#EA7C72">{{ ajaxData.stopNum ? ajaxData.stopNum : 0 }}台断电</span>
          </li>
          <li>
            <img src="../assets/images/legend4.png" />
            <span style="color:#ECD476">{{ ajaxData.runNum ? ajaxData.runNum : 0 }}台在运行</span>
          </li>
        </ul>
      </div>
    </div>
